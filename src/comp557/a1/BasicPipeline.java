...
public class BasicPipeline {
    ...
    private Stack<Matrix4d> mMatrixStack;
    private Stack<Matrix4d> mInvTMatrixStack;
	...
	public BasicPipeline( GLAutoDrawable drawable ) {
        ...
        lightIntensityID = gl.glGetUniformLocation(glslProgramID, "lightIntensity");
        ambientID = gl.glGetUniformLocation(glslProgramID, "ambient");
        viewingID = gl.glGetUniformLocation(glslProgramID, "viewing");
	...
	public void initStacks() {
		this.mMatrixStack = new Stack<Matrix4d>();
		this.mInvTMatrixStack = new Stack<Matrix4d>();
		
		this.mMatrixStack.push((Matrix4d) this.MMatrix.clone());
		this.mInvTMatrixStack.push((Matrix4d) this.MinvTMatrix.clone());
	}
	...
	public void enable( GLAutoDrawable drawable ) {
        ...
        Vector3f lightIntensity = new Vector3f((float) 0.5, (float) 0.5, (float) 0.5);
        lightIntensity.normalize();
        gl.glUniform3f(lightIntensityID, lightIntensity.x, lightIntensity.y, lightIntensity.z);
        Vector3f ambient = new Vector3f(1, 1, 1);
        ambient.normalize();
        gl.glUniform3f(ambientID, ambient.x, ambient.y, ambient.z);
        Vector3f viewing = new Vector3f((float) VMatrix.m03, (float) VMatrix.m13, (float) VMatrix.m23);
        viewing.normalize();
        gl.glUniform3f(viewingID, viewing.x, viewing.y, viewing.z);
	}
	...
	public void pop() {
		...
		this.MinvTMatrix = this.mInvTMatrixStack.pop();
	}
